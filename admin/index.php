...
echo "<div class='right-button-margin'>";
    echo "<a href='view_products.php' class='btn btn-default pull-right'>Read Products</a>";
echo "</div>";
echo "<br>";
echo "<br>";
...
<form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post" enctype="multipart/form-data">
    ...
    <table class='table table-hover table-responsive table-bordered'>
        ...
        <tr>
            <td>Retail Price</td>
            <td><input type='text' name='retailprice' class='form-control' /></td>
        </tr>
         <tr>
            <td>Profit</td>
        ...
        <tr>
         ...
         <tr>
            <td>Current Stock</td>
            <td><input type='text' name='current_stock' class='form-control' /></td>
        </tr>		
        <tr>
            <td>Category</td>
            <td>
