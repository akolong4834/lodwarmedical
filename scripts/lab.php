...
<head>
     ...
     <title>Laboratory Tests We Do</title>
<!--
          ...
          <div class="container">
               ...
               <div class="collapse navbar-collapse">
                    <ul class="nav navbar-nav navbar-right">
                         ...
                         <li><a href="index.php" class="smoothScroll">Medicine </a></li>
                         <li><a href="index.php" class="smoothScroll">Contact</a></li>
                         <li class="appointment-btn"><a href="index.php">Make an appointment</a></li>
						 <li class="appointment-btn"><a href="index.php">Become A Member</a></li>
